...
const Logo = forwardRef(({ disabledLink = false, sx }, ref) => {
  const logo = (
    <Box sx={{ width: 40, height: 40, cursor: 'pointer', ...sx }}>
      <svg viewBox="0 0 517.9503155968744 93.41230538960505" width={150}>
        <g transform="matrix(1,0,0,1,122.4303155968744,15.976631050004514)">
          <svg viewBox="0 0 395.52 61.459043289596025" height={61.459043289596025} width={395.52}>
            <g id="textblocktransform">
              <svg
                viewBox="0 0 395.52 61.459043289596025"
                height={61.459043289596025}
                width={395.52}
                id="textblock"
              >
                <g>
